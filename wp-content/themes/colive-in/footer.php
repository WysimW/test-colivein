   ...
   <footer class="bg-colored">
       <div class="container d-flex justify-content-between footer-section flex-wrap">
           <ul>
               <li> <img class="footer-logo" src="assets/images/logo-noir.png" alt="Colive'in logo"> </li>
               <li>8 allée champêtre</li>
               <li>62161 Duisans</li>
               <li class="phone-number">Tél. 06 07 69 38 50</li>
               <li>Ensemble, vivons une seconde jeunesse.
               </li>
           </ul>
